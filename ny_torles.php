...
<table id="table">
	...
	<tr class="<?php if(isset($classname)) echo $classname;?>">
		<td><?php echo $row["ny_sorozatszam"]; ?></td>
		<td><?php echo $row["ny_marka"]; ?></td>
		<td><?php echo $row["szines"]; ?></td>
		<td><a href="ny_delete.php?ny_sorozatszam=<?php echo $row["ny_sorozatszam"]; ?>">Törlés</a></td>
	</tr>
